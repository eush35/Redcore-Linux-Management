...
<link href="/admin/assets/css/fm.css" rel="stylesheet">
</head>
<body>
     <!--*******************
        Preloader start
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="/admin/data/fm/redfilemanager/index.php">RedFile Manager</a></li>
                        </ol>
                    </div>
                </div>
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">RedFile Manager</h4>
                            </div>
                            <div class="card-body">
                            <header>
                            <h1 style="color:red;">RedFile Manager</h1>
                        </header>
                        <main>
                            <div id="file-list"></div>
                        </main>
                        <footer>
                            <input type="text" id="ftp-url" placeholder="FTP URL">
                            <input type="text" id="ftp-username" placeholder="Kullanıcı Adı">
                            <input type="password" id="ftp-password" placeholder="Parola">
                            <button id="connect-button">Bağlan</button>
                            <button id="disconnect-button">Bağlantıyı Kes</button>
                        </footer>

                        <script src="/admin/assets/js/fm.js"></script>
                                </div>
                            </div>
                        </div>
                </div>
